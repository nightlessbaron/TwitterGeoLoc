...
@register('profileplus')
class ProfilePlusResolver(AbstractResolver):
        ...
        for alias in aliases:
            ...
            if alias in self.location_name_to_location:
                if location.population > alias_dict[alias]:
                    #with open('analysis_locations.txt', 'a') as ffi:
                        #ffi.write('---------------------------------------'+'\n')
                        #ffi.write(alias + '\t'+ str(self.location_name_to_location[alias])+'\n')
